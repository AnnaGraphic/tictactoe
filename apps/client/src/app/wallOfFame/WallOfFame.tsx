...
export function WallOfFame(props) {
  ...
  const server_endpoint = process.env.NX_SERVER_ENDPOINT || "http://localhost:3333";
        ...
        {games.map((game) => {
          return (
            <li className="table-row">
              ...
              <div className="col col-4" data-label="loser">
                {game.user_o}
              </div>
              <div className="col col-5" data-label="avatar loser">
                {game.user_o_avatar}
              </div>
            </li> 
          );
